...
import 'package:dailynews_app/data/datasources/article_remote_data_source.dart';
import 'package:dailynews_app/data/repositories/article_repository_impl.dart';
import 'package:dailynews_app/domain/repositories/article_repository.dart';
import 'package:dailynews_app/domain/usecases/get_article_category.dart';
import 'package:dailynews_app/domain/usecases/get_bookmark_articles.dart';
import 'package:dailynews_app/domain/usecases/get_bookmark_status.dart';
import 'package:dailynews_app/domain/usecases/get_headline_business_articles.dart';
import 'package:dailynews_app/domain/usecases/get_top_headline_articles.dart';
import 'package:dailynews_app/domain/usecases/remove_bookmark_article.dart';
import 'package:dailynews_app/domain/usecases/save_bookmark_article.dart';
